...
class Chart extends Component {
  ...
  componentDidMount(){
    ...
    this.state.myChart = echarts.init(document.getElementById('box'));
    // 绘制图表
    
  }
  getOption = ()=> {
    const {valueList,dateList} = this.props
    return {
  ...
  render() { 
    ...
    myChart&&myChart.setOption(this.getOption());
    return ( <div id='box' style={{ width: 1100, height: 680 }}></div> );
  }
}
